                        ...
                        <ul class="list-unstyled menu-product">
                            ...
                            <div class="col-sm-4">
                                <li>
                                    ...
                                    <h4><i class="fa fa-bars" aria-hidden="true"></i> <%= proDAO.getAllProduct("").get(i).getProductname()%></h4>
                                    <p><i class="fa fa-btc" aria-hidden="true"></i> <%= proDAO.getAllProduct("").get(i).getProductprice()%> VNĐ</p>
                                    <div class="icon" >
                                        <center><a href="GioHangServlet?action=xem&idsanpham=<%= proDAO.getAllProduct("").get(i).getProductid()%>"><button type="button" class="btn btn-default">Xem Chi Tiết <i class="fa fa-info-circle" aria-hidden="true"></i></button></a>
                                            
                                        <a href="GioHangServlet?action=add&idsanpham=<%= proDAO.getAllProduct("").get(i).getProductid() %>&idnguoidung=${IDNGUOIDUNG}&page=index" style="margin-left: 40px;"><button type="button" class="btn btn-default">Thêm Vào Giỏ <i class="fa fa-cart-plus" aria-hidden="true"></i></button></a></center>
